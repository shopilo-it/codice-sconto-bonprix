#!/usr/bin/env python3
"""
Recupero codici sconto Bonprix da shopilo.it
Sursa: https://shopilo.it/negozi/bonprix.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/bonprix.it"
STORE_NAME = "Bonprix"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Bonprix da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-bonprix)"
    }
    try:
